...
const StudentInfoCard = ({datas,names,username,dob,profilePhoto, dobreturn, cohort,filterCohort}) => { //need all the info so I can use it in the return -- needs to be pass from - student list. 
...
return (
    ...
    <>
    <p>{filterCohort}</p>
    <p>{cohort.cohortCode} kjhdhfsdhf</p>
